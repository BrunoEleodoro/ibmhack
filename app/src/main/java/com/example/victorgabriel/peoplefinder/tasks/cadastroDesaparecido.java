...
public class cadastroDesaparecido extends AsyncTask<String,String,String> {
    ...
    $contato = @$_GET["contato"];
         */
        res = internet.get("novoCadastro.php?nome_des="+nome_des+"&idade_des="+idade_des+"&latitude="+latitude+"&longitude="+longitude+"&descricao="+descricao+"&data="+data+"&hora="+hora+"7contato="+contato,"base64="+base64(file));
        return res;
    }
